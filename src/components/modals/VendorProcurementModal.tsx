...
export const VendorProcurementModal: React.FC = () => {
  ...
  const baseAlerts = calculateStockAlerts(products);
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-4 select-none">
      <div className="bg-pos-panel border border-pos-border rounded-2xl w-full max-w-6xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 h-[92vh] flex flex-col relative">
