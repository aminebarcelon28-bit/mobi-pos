  ...
  return (
    ...
    >
      <div
        ...
        className="bg-pos-panel border border-pos-border rounded-2xl w-full max-w-5xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 h-[85vh] flex flex-col cursor-default"
      >
        {/* Header */}
